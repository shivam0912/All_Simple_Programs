...
public class BinarySearch {
    public static int binaryIterativeSearch(int[] a,int size,int data){
        int low=0;
        int high = size;
    ...
    public static void main(String[] args) throws IOException {
        ...
        if(binaryIterativeSearch(a,n-1,data)==-1)
            System.out.println("Sorry ): Element is not available in the array:");
        else
            System.out.println("Element at the position: "+binaryIterativeSearch(a,n-1,data));
    }
}
